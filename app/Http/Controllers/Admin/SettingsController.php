...
class SettingsController extends MainAdminController
{
    ...
    { 
        ...
        $settings = Settings::where('group_id', '=', Auth::User()->group_id)->firstOrFail();
    ...
    {  
		...
		$settings->clients_count = $inputs['clients_count'];
		$settings->hours_count = $inputs['hours_count'];
		$settings->projects_count = $inputs['projects_count'];
    ...
    {  
		...
		$settings->about_us_title_ru = $inputs['about_us_title_ru'];
		$settings->about_us_description_ru = $inputs['about_us_description_ru'];
    ...
    public function prices_page(Request $request)
    {  
		...
		$settings->prices_title = $inputs['prices_title'];
		$settings->prices_description = $inputs['prices_description'];
