    ...
    public function postEmail(Request $request)
   {
       ...
       switch ($response) {
           case Password::RESET_LINK_SENT:
               ...
               return redirect()->route('login')->with('flash_message', 'We have e-mailed your password reset link!');
    ...
    public function postReset(Request $request)
    {
        ...
        switch ($response) {
            case Password::PASSWORD_RESET:
                ...
                return redirect()->route('login')->with('flash_message', 'Please check your e-mail!');
