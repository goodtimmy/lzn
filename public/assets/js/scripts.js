...
function initDomik() {
	...
	$('.slide-title a , .box-item a.ajax , .carousel-link-holder, .logo-holder a.ajax').on('click',function(){
...
// contact form ------------------
    /*$("#contactform").submit(function() {
        ...
        $("#user_message").slideUp(750, function() {
            $("#user_message").hide();
            ...
            $.post(a, {
                ...
                document.getElementById("user_message").innerHTML = a;
                $("#user_message").slideDown("slow");
