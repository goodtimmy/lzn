               ...
               <!-- <div class="avatar">
				...
				<span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" placeholder="Подтвердить пароль">
                        </div>
                       
                         
                    </div>
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary"> Сбросить пароль <i class="md md-lock-open"></i></button>
                    </div>
                {!! Form::close() !!} 
            </div>
