            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login">
                    <div class="logo" href="#" align="">
                        <a href="{{ URL::to('/') }}"><img src="{{ URL::asset('upload/'.getcong('site_logo')) }}"
                                                          alt=""/></a>
                    </div>
                    <div class="panel panel-default panel-shadow">
                            ...
                            <div class="form-group margin-none">
                                <div class="media">
                                    ...
                                    <div class="media-right media-middle">
                                        <a href="{{ URL::to('admin/password/email') }}"
                                           class="small pull-right">Забыли?</a>
                                    </div>
                                </div>
                        ...
                        <div class="form-group text-center">
                            <button type="submit" class="btn btn-primary">Авторизоваться <i class="md md-lock-open"></i>
                            </button>
                        </div>
                        {!! Form::close() !!}
                    </div>
