<nav class="navbar navbar-default navbar-fixed-top">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="{{ URL::to('admin/reservations') }}">{{getcong('site_name')}}</a>
			...
			<ul class="nav navbar-nav navbar-right">
				<li>
					<div class="btn-group navbar-btn">
						<a href="{{ URL::to('admin/logout') }}">{{__('Sign out')}} <i class="md-exit-to-app"></i></a>

						<a href="{{ URL::to('/') }}" class="btn btn-success" target="_blank"><i class="md md-visibility"></i> {{__('Go to the site')}}</a>
					</div>
				</li>
				<!--
				<li>
