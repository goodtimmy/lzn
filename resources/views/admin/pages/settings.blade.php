...
<div id="main">
	<div class="page-header">
		<h2> Настройки</h2>
		<a href="{{ URL::to('admin/dashboard') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> Назад</a>
...
<span aria-hidden="true">&times;</span></button>
    ...
    <div class="tab-content tab-content-default">
        ...
        <div role="tabpanel" class="tab-pane" id="prices">
            ...
            {!! Form::open(array('url' => 'admin/prices','class'=>'form-horizontal padding-15','name'=>'prices_form','id'=>'prices_form','role'=>'form')) !!}
